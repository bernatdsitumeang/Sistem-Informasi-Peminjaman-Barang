...
<div class="container py-5">
    <div style="display: flex;">
        <div style="flex: 50%;"><h4 class="font-rubik font-size-20 text-dark">Menampilkan pencarian: <?php echo $_GET["search_query"]; ?></h4></div>
        <div>
            <form action="<?php echo site_url('cari');?>" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                <div class="input-group">
                    <input type="text" name="search_query" class="form-control bg-light border-0 small" value="<?php echo $_GET["search_query"]; ?>" placeholder="Cari produk..." aria-label="Search" aria-describedby="basic-addon2">
